...
class News(models.Model):
    ...
    image = models.ImageField(upload_to= "NewsImage", help_text=" добавте картинки! ", blank=True)
...
class Author(models.Model):
    ...
    IdUser = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=False, db_column="IdUser") #NOTE: переделать на что то более удобонее в взаимодействии
